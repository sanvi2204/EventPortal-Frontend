        ...
        <>
            <div className='p-0 m-0 h-[90vh] w-screen flex justify-center items-center flex-col'>
                <form className='flex flex-col gap-5 bg-slate-50/80 h-4/6 w-[30%] items-center justify-center rounded-md shadow-md shadow-red-100' onSubmit={handleSubmit}>
                    ...
                    <input type="email" name="" id="email" placeholder='Email' className='bg-gray-400 outline-none border-2 border-transparent focus:border-b-2 focus:border-b-red-300 rounded-sm w-[100%] text-black placeholder:text-black p-2 shadow-sm' onChange={handleChange} required />
                    <input type="password" name="" id="password" placeholder='Password' className='bg-gray-400 outline-none border-2 border-transparent focus:border-b-2 focus:border-b-red-300 rounded-sm w-[100%] text-black placeholder:text-black p-2 shadow-sm' onChange={handleChange} required />
